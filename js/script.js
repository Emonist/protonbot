const commandsData = {
  ...
  category2: {
    ...
    title: "AI",
    commands: [
      { name: "ask", description: "Ask anything to the AI", permission: "All" },
      { name: "translate", description: "Translate text", permission: "All" },
      { name: "code", description: "Generate code using AI", permission: "All" },
      { name: "define", description: "Define any term", permission: "All" },
      { name: "idea", description: "Get creative ideas", permission: "All" },
      { name: "story", description: "Generate a story", permission: "All" },
      { name: "explaincode", description: "Explain code using AI", permission: "All" },
      { name: "recipe", description: "Get a cooking recipe", permission: "All" },
      { name: "compare", description: "Compare two topics", permission: "All" },
      { name: "fact", description: "Get a fact", permission: "All" },
      { name: "poem", description: "Generate a poem", permission: "All" },
      { name: "solve", description: "Solve a problem", permission: "All" },
      { name: "interview", description: "AI-based interview Q&A", permission: "All" },
      { name: "character", description: "Generate a character", permission: "All" },
    ],
  },
  category3: {
    icon: "🛡️",
    title: "Moderation",
    commands: [
      { name: "ping", description: "Check bot latency", permission: "All" },
      { name: "prefix", description: "Change bot prefix", permission: "Administrator" },
      ...
      { name: "firstmessage", description: "Jump to first message", permission: "All" },
      ...
      { name: "afk", description: "Set AFK status", permission: "All" },
      ...
      { name: "pat", description: "Pat a user", permission: "All" },
    ],
  },
  category4: {
    icon: "✨",
    ...
    commands: [
      ...
      { name: "invite", description: "Generate invite link", permission: "Create Instant Invite" },
      { name: "insight", description: "Get server insight", permission: "View Audit Log" },
      { name: "avatar", description: "View avatar", permission: "All" },
      ...
      { name: "spotify", description: "Display Spotify info", permission: "All" },
      { name: "boost", description: "View boost info", permission: "All" },
      { name: "status", description: "Check user status", permission: "All" },
      { name: "list", description: "List commands/users", permission: "All" },
      { name: "botinfo", description: "Show bot statistics", permission: "All" },
    ],
  },
  category5: {
    icon: "🔧",
    ...
    commands: [
      ...
      { name: "uptime", description: "Check bot uptime", permission: "All" },
      { name: "serverinfo", description: "View server info", permission: "All" },
